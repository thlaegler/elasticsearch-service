...
INSERT INTO product (id, description, item_code, name, manufacturer, price_id) VALUES (NULL, "Blue", "123", "Blue Shirt", "Gucci", 1);
INSERT INTO product (id, description, item_code, name, manufacturer, price_id) VALUES (NULL, "Red", "321", "Red Shirt", "Gucci", 2);
INSERT INTO product (id, description, item_code, name, manufacturer, price_id) VALUES (NULL, "Green", "231", "Green Shirt", "Prada", 3);
